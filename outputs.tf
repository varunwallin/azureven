...
output "subscription_id" {
  value       = module.subscription[0].subscription_id
  description = "The subscription_id is the Azure subscription ID that resources have been deployed into."
}

output "subscription_resource_id" {
  value       = module.subscription[0].subscription_resource_id
  description = "The Azure resource ID of the newly created subscription."
}

output "management_group_subscription_association_id" {
  value       = module.subscription[0].management_group_subscription_association_id
  description = "The ID of the management group subscription association, if enabled."
}


output "resource_group_id" {
  value       = module.resource_groups.resource_group_id
  description = "The ID of the resource group created by the submodule."
}
